			            	...
			            	<div class="inout d-flex">
			                    ...
			                    <div class="w-75">
									...
									<label for="2">リフォーム相談</label><br>  
  									<input type="radio" id="3" name="b-13" value="見積もり相談">
  									<label for="3">見積もり相談</label><br>
  									<input type="radio" id="4" name="b-13" value="資料請求">
  									<label for="4">資料請求</label><br>
  									<input type="radio" id="5" name="b-13" value="その他">
  									<label for="5">その他</label><br>
			                    </div>
			                </div>
			            	<div class="inout center-vertical-nojustify">
			                    <span class="title w-25">お問い合わせ内容 <br>（必須）</span>
			                    <textarea rows="5" cols="50" class="w-75"></textarea>
			                </div>
